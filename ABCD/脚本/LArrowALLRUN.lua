...
SetNeedSkillLineData(100,"瓦爾．閃電箭矢,nil|附加冰冷傷害輔助,nil|元素攻擊傷害輔助,nil|三體輔助,nil|啟發輔助,nil|幻影射手輔助,nil|附加火焰傷害輔助,nil",nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,12)

SetNeedSkillLineData(96,"魔改箭矢輔助,nil|箭雨,nil|冰霜射擊,nil",nil,10,1)
SetNeedSkillLineData(97,"元素淨化,nil|啟蒙輔助,nil|憤怒,nil",nil,9,1)
SetNeedSkillLineData(98,"擊中時印記輔助,nil|狙擊者印記,nil|狂戰,nil|鋼筋鐵骨,nil",nil,5,1)
SetNeedSkillLineData(99,"魔改箭矢輔助,nil|狂怒,nil|暴擊獲得暴擊球輔助,nil|龍捲射擊,nil|誘捕箭矢,nil|元素打擊,nil",nil,3,1)
